...
# Last updated by Elaina Passero 10/18/19
...
get.results <- function(wd,reach_name,skip_num,dis_unit){
...
csv_list <- lapply(iric_results, function(i){
...
names(csv_list) <- paste(dis_unit,"_",modeled_q,sep="")

holdList$csv_list <- csv_list
