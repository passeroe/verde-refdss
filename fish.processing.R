...
list.save(fish_outputs,file=paste(reach_wd,reach_name,"_fish_outputs.rdata",sep=""))

# create plots of the habitat area-discharge curves
source("plot.a.q.curve.R")
area_look_plots <- lapply(lifestages, function(a) plot.a.q.curve(fish_outputs,species_list,a,NormalizeByL))
