...
plot.a.q.curve.in.chan <- function(fish_outputs,species_list,a,NormalizeByL){
  ...
  ggsave(paste(reach_wd,reach_name,"_a_q_curves_","inchannel.png",sep=""),plot=plt,width=7, height=5,units = "in")
  return(plt)
}
